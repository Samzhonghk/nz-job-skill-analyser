...
def summurize_skill_counts(
    list_of_skill_counts: list[dict[str, str | int]],
) -> dict[str, int]:
    result = {}
...
def parse_agr():
    ...
    parse.add_argument(
        "input",
        help="Path to the job description file or folder containing job description files.",
    )
    parse.add_argument(
        "--output",
        default=None,
...
def main() -> None:
    ...
    if arg_input.is_dir():
        ...
        print("Skill totals have been written to skills_totals.csv")
